...
public class DodajDvijeMatriceAlgebra {
	public static double[][] addMatrix(double[][] a, double[][] b) { // metoda za sabiranje dvijematrice
	...
	public static void main(String[] args) {
		...
		double[][] c = addMatrix(a, b);                   // da saberemo elemnte unijete od korisnika pozivamo se na prethodno kreiranu metodu koja ce ih sabrati
